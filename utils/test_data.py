...
REGISTER_NO_EMAIL = {"password": "test1234"}


REGISTER_INVALID_EMAIL = {"email": "testexample.com", "password": "test1234"}

VALID_REGISTER_DATA = {"email": "eve.holt@reqres.in", "password": "pistol"}


VALID_USER = {"name": "Jan Kowalski", "job": "QA Engineer"}


UPDATED_USER = {"name": "Jan Kowalski", "job": "Senior QA Engineer"}


PARTIAL_UPDATE_USER = {"job": "QA Automation Engineer"}
